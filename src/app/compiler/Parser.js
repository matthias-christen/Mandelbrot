  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "BaseExpression": parse_BaseExpression,
        "ExponentExpression": parse_ExponentExpression,
        ...
        "BracketedExpression": parse_BracketedExpression,
      ...
      function parse_Expression() {
        ...
        if (result0 === null) {
          result0 = parse_BracketedExpression();
        }
        return result0;
      }
      
      function parse_BaseExpression() {
        var result0;
      ...
      function parse_ExponentExpression() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1, pos2;
        
        pos0 = pos;
        pos1 = pos;
        result0 = parse_BaseExpression();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse__();
        ...
        if (result0 !== null) {
          result0 = (function(offset, e, tail) {
            var ret = e;
            var len = tail.length;
      ...
      function parse_UnaryExpression() {
        ...
        if (result0 !== null) {
          result1 = parse__();
          if (result1 !== null) {
            result2 = parse_ExponentExpression();
            if (result2 !== null) {
      ...
      function parse_BracketedExpression() {
      ...
      function parse_FunctionExpression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, fn, arg) {
            return {
